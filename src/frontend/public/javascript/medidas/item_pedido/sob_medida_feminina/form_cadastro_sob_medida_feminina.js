...
async function adicionarMedidas(dados){
    try {
        ...
        window.location.href = `/medidas/itens-pedidos/${dados.item_pedido_id}/SobMedida/feminina?msg=${data.msg}`
    } catch (error) {
        window.location.href = `/medidas/itens-pedidos/${dados.item_pedido_id}/cadastro/SobMedida/feminina?error=${error}`
    }
}

function voltar(id){
    window.location.href = `/medidas/itens-pedidos/${id}/SobMedida/feminina`
}
