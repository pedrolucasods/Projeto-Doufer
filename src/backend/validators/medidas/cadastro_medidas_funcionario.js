function ValidatorCadastroMedidaFuncionario(Dados,res){
    const campos = Object.keys(Dados)
    if(campos.length!=2){
        res.status(400).json({'erro':'Erro ao cadastrar medida do funcionario!'})
        return false
    ...
    if(Dados.tipo_medida == 'padrao'){
        ...
        if (
            !campos_medidas.includes('funcionario_id') ||
...
module.exports = {ValidatorCadastroMedidaFuncionario}